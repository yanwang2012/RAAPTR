...
/*!
Special parameters struct to pass parameters specific to LLR_Mp_Av fitness
function. See how_to_code_fitnessFunc.txt for an example of a special parameter
structure.
*/
...
/*! MISSING DOCUMENTATION */struct cfunc_OUTPUT {
  // double fitVal;
  double *c;
  double *v;
};
...
size_t llrpsochkcoord(const size_t, const gsl_vector *, const gsl_vector *,
