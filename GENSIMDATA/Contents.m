...
% Files
%   binPlot_script         - 
%   binsrcParams           - Extract parameters of sources in frequency bin X (Mauritius Poster)
...
%   InnProduct             - Function to calculate the noise weightred inner product (ip)
%   likelihood             - log likelihood ratio for a single pulsar
%   LLR_PSOmpp             - Function to calculate the likelihood ratio for particle swarm 
%   loadhdf5               - Load data from an HDF5 file into workspace
%   LogLikelihoodRatioMP5  - log likelihood ratio function which maximizing over pulsar phase-MP,
...
%   postDataCheck          - 
%   procperfeval           - Post-processing of the output from PERFEVAL
%   rotm_coo               - --------------------------------------------------------
%   searchParam_mat2hdf5   - A script convert searchParams file from .mat to hdf5
%   simulator_skaNano      - It is a simulator based on simulator2.m, we make it to simulate the data 
%   SpherePointPicking     - Uniform random Sphere Point Picking
%   test_gensimdata        - This is a test.m file to generate the necessary
