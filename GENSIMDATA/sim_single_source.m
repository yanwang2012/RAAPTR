% script to simulate single source data, used to investigate the
% Lomb-Scargle periodogram and SHAPES performance.
...
path_to_parameters = '/Users/yiqianqian/Library/Mobile Documents/com~apple~CloudDocs/Research/PulsarTiming/SimDATA/Lomb-Scargle/GWBsimDataSKAParams.mat';
path_to_output = '/Users/yiqianqian/Library/Mobile Documents/com~apple~CloudDocs/Research/PulsarTiming/SimDATA/Lomb-Scargle';
path_to_pulsar_catalog = 'survey_ska.mat';
path_to_simData = '/Users/yiqianqian/Library/Mobile Documents/com~apple~CloudDocs/Research/PulsarTiming/SimDATA/Lomb-Scargle/GWBsimDataSKASrlz45Nrlz1.mat';
...
%% GW Source parameters setup
source_param = load(path_to_simData);
...
for jj=1:1:Nrlz
    ...
    filename=strcat('Lomb-Scargle2','Nrlz',num2str(jj),'.mat'); % change Srlz when changing rng seed.
...
filename=strcat('Source_params2','.mat');
save([simDataDir,filesep,filename],'Amp','alpha','delta',...
    'omega','iota','thetaN','phi0','stdTrueCoord');

% simulating noise without signal
Nnis=1; %100;  % number of realization of pure noise
perfect_fitness = 0;
snr_chr = 0;
