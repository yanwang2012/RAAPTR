...
outputDir = '/Users/qyq/Research/PulsarTiming/SimDATA/MultiSource/Investigation/Test11/searchParams/2bands/overlap-acceptance';
searchRange = load([simParamsDir,filesep,'searchParams1.mat']);
delta = (searchRange.searchParams.angular_velocity(1) - searchRange.searchParams.angular_velocity(2))/10; % overlaping frequency interval
