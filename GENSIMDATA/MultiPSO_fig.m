...
% nFile = dir([estDataDir,filesep,inputFileName,'*.mat']); % For MBLT and other tests with irregular filename.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Noise processing
noisedir = '~/Research/PulsarTiming/SimDATA/MultiSource/Investigation/Test10/noise/Results20/';
...
avgnx = sum(reshape(nx,N,num_ite),1)/N;

%% plot the entire map
close all;
prefix = [estDataDir,filesep,'fig'];
mkdir(prefix);
figname = ['2 bands 200 SRC superNarrow iMBLT1 5 SRC Removed'];
figure(1)
% yyaxis right
