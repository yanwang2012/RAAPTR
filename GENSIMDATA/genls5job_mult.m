...
DataDir = '/Users/qyq/Library/Mobile Documents/com~apple~CloudDocs/Research/PulsarTiming/SimDATA/MultiSource/Investigation/Final/realizations/2bands/simData/Band_opt_diff'; % local
...
searchParamDir = '/work2/05884/qyqstc/lonestar/MultiPSO/Final/realizations/2bands/searchParams/Band_opt/'; % end with /
dataDir = '/work2/05884/qyqstc/lonestar/MultiPSO/Final/realizations/2bands/simData/Band_opt_diff/HDF5/'; % end with /
resultsDir = [dataDir,'results/'];
ite = 20;


fid = fopen('/Users/qyq/Library/Mobile Documents/com~apple~CloudDocs/Research/PulsarTiming/SimDATA/MultiSource/Investigation/Final/JOBFILE_Diff_Srlz_Opt.txt','w');% 'a' for appending data at the end of the file.

%% Write file
for r = 1:Nreal
    inFileList_para = dir([search_paramDataDir,filesep,folderName{r},filesep,'HDF5',filesep,'*.hdf5']); % uncomment if each realization has its own searchParams
    ...
    for lpc = 1:nParamFiles
        ...
        %         searchParams.
        fprintf(fid,'%s%s/%s ',searchParamDir,folderName{r},ParaNames{lpc}{1});
