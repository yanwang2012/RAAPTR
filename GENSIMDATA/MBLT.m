...
estDataDir = '~/Research/PulsarTiming/SimDATA/MultiSource/Investigation/Test11/Sources/Results';
...
OutputDir = ['~/Research/PulsarTiming/SimDATA/MultiSource/Investigation/Test11/Sources',filesep,inputFileName];
mkdir(OutputDir);
for i = 1:Npara
    for j = 1:NestSrc
